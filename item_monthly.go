...
type ItemMonthly struct {
	Name        string `json:"name,omitempty" validate:"required"`
	Description string `json:"description,omitempty"`
	Cost        string `json:"unit_cost,omitempty"`
}

func (i *Item) unitCostMonthly() decimal.Decimal {
...
func (i *Item) totalWithoutTaxAndWithDiscountMonthly() decimal.Decimal {
...
func (i *Item) totalWithTaxAndDiscountMonthly() decimal.Decimal {
	return i.totalWithoutTaxAndWithDiscount().Add(i.taxWithDiscount())
}

func (i *Item) taxWithDiscountMonthly() decimal.Decimal {
...
func (i *Item) appendColToMonthly(options *Options, pdf *gofpdf.Fpdf) {
